                    ...
                    <div class="col-lg-8">
                        <div class="slide2">
                            ...
                            if (isset($_POST['save_change'])) {
                                ...
                                if (empty($formerror)) {
                                    $stmt = $connect->prepare('UPDATE users SET email=?,phone=?,birthday=?,address=?,six=?,id_number=? WHERE name=?');
                                    $stmt->execute(array($email, $phone, $birthday, $address, $six,$id_number, $_SESSION['username']));
                            ...
                            <div class="my_form">
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="box">
                                        ...
                                        <select name="six" id="" class="form-control select2">
                                            <option value=""> حدد الجنس</option>
                                            <option <?php if ($userdata['six'] == 'ذكر') echo "selected"; ?>
                                                    value="ذكر">ذكر
                                            </option>
                                            <option <?php if ($userdata['six'] == 'انثي') echo "selected"; ?>
                                                    value="انثي">انثي
                                            </option>
                                        </select>
                                    ...
                                    <div class="box">
                                        ...
                                        <input type="text" name="id_number" id="id_number" class="form-control"
                                               value="<?php echo $userdata['id_number']; ?>">
                                    </div>
                                    <div class="box">
                                        <label for=""> صورة جواز السفر </label>
                                        <input type="file" name="passport" id="phone" class="form-control"
                                               value="<?php echo $userdata['passport']; ?>">
                                    </div>
                                    <div class="box">
                                        <label for=""> صورة الملف الشخصي </label>
                                        <input type="file" name="profile_image" id="phone" class="form-control"
                                               value="<?php echo $userdata['profile_image']; ?>">
                                    </div>
                                    <div class="box">
